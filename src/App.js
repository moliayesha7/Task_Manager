    ...
    <div className="isolate bg-white">
              ...
              <div className="mt-6 flow-root">
                <div className="-my-6 divide-y divide-gray-500/10">
                  <div className="space-y-2 py-6">
                    <a href="#" className="-mx-3 block rounded-lg py-2 px-3 text-base font-semibold leading-7 text-gray-900 hover:bg-gray-400/10">Dashboard</a>  
                    <a href="#" className="-mx-3 block rounded-lg py-2 px-3 text-base font-semibold leading-7 text-gray-900 hover:bg-gray-400/10">Add Task</a>
                  </div>
      ...
      <main>
        <div className="relative px-6 lg:px-8">
          <div className="mx-auto max-w-3xl pb-32 pt-5 sm:pb-40">
